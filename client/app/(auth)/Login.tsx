...
function LoginForm() {
    ...
    return (
        ...
        >
            ...
            {registered && (
                <div className="w-full max-w-sm mb-4 bg-[#B8FF3C]/10 border border-[#B8FF3C]/30 rounded-xl px-4 py-3 text-[#B8FF3C] text-sm text-center font-medium">
            ...
            <div className="w-full max-w-sm bg-[#0e1a09]/90 border border-white/[0.08] rounded-2xl p-7 shadow-2xl backdrop-blur-sm">
                ...
                <div className="mb-6">
                    <h1 className="text-2xl font-black text-white leading-tight">Welcome back, athlete</h1>
                    <p className="text-white/40 text-sm mt-1">Ready to crush your goals today?</p>
                </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <div>
                        <div className="flex items-center justify-between mb-1.5">
                            ...
                            <Link href="/forgot-password" className="text-xs font-bold text-[#B8FF3C] hover:text-[#d4ff6e] transition-colors">
                                Forgot?
                            </Link>
                        </div>
                        <div className="relative">
            ...
            <p className="text-sm text-white/40 mt-5">
                ...
                <Link href="/register" className="font-black text-[#B8FF3C] hover:text-[#d4ff6e] transition-colors">
                    Sign up for free
                </Link>
            </p>
        </div>
